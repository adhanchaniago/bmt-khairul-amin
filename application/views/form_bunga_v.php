	...
	<div class="col-md-12">
		...
		<div class="form-group">
			...
			<tr> 
				...
				// tipe bunga
				$options = array(
					'A'  => 'A: Persen Margin dikali angsuran bln',
					'B'  => 'B: Persen Margin dikali total pinjaman'
					//'C'  => 'C: Bunga Menurun = Persen Bunga dikali sisa pinjaman'
					);
				echo form_label('Tipe Pinjaman Margin', 'pinjaman_bunga_tipe');
			...
			<tr>
				...
				echo form_label('Suku Margin Pinjaman (%)', 'bg_pinjam');
				echo form_input($data);
				echo '
				</td>
				<td>';
