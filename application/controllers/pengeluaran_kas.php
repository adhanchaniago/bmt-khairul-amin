...
class Pengeluaran_kas extends OperatorController {
	...
	public function index() {
		...
		$this->data['judul_sub'] = 'Pengeluaran Kas Tunai <a href="'.site_url('pengeluaran_kas/form').'" class="btn btn-sm btn-success">Import Data</a>';
	...
	public function form() {
	    ...
	    if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form
	      ...
	      $upload = $this->Pengeluaran_m->upload_file($this->filename);
	    ...
	    $this->data['isi'] = $this->load->view('pengeluaran_import_v', $this->data, TRUE);
	    $this->load->view('themes/layout_utama_v', $this->data);
	...
	public function import(){
	    ...
	    foreach($sheet as $row){
	      ...
	      if($numrow > 1){
	        ...
	        array_push($data, array(
	          ...
	          'tgl_catat'=>$row['B'], // Insert data nama dari kolom B di excel
	          'keterangan'=>$row['C'], // Insert data jenis kelamin dari kolom C di excel
	          'dari_kas_id'=>$row['D'], // Insert data alamat dari kolom D di excel
	          'jns_trans'=>$row['E'], // Insert data alamat dari kolom D di excel
	          'jumlah'=>$row['F'], // Insert data alamat dari kolom D di excel
	          'user_name'=>$row['G'], // Insert data alamat dari kolom D di excel
	        ));
	      }
	    ...
	    $this->Pengeluaran_m->insert_multiple($data);
	    
	    redirect("Pengeluaran_kas"); // Redirect ke halaman awal (ke controller siswa fungsi index)
  }
}